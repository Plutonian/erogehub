...
import com.goexp.galgame.gui.db.mongo.Query.GameQuery.GameImgQuery
import com.mongodb.client.model.Filters
import javafx.collections.{FXCollections, ObservableList}
import javafx.concurrent.Task

class GameImgListTask(gameId: Int) extends Task[ObservableList[GameImg]] {
  override protected def call: ObservableList[GameImg] = {
    val g = GameImgQuery.tlp.query.where(Filters.eq(gameId)).one
