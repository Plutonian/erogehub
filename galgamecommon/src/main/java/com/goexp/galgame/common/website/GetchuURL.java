...
public final class GetchuURL {
    ...
    public static class GameList {
        ...
        public static String byDateRange(LocalDate from, LocalDate to) {
            return UrlBuilder
                    .create(searchUrl)
                    .param("search", "1")
        ...
        public static String byBrand(int brandId) {
            return UrlBuilder
                    .create(searchUrl)
                    .param("search", "1")
                    .param("sort", "release_date")
    ...
    public static class Game {
        ...
        public static String byId(int gameId) {
