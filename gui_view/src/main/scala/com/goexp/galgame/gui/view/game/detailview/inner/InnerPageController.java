...
public class InnerPageController extends DefaultController {

    private static final URL VIEW_GAME_DETAIL_PART_PERSON_CELL_FXML = PersonCellController.class.getResource("person_cell.fxml");
    @FXML
...
//    private Service<ObservableList<Game.GameCharacter>> charListByGameService = new TaskService<>(() -> new GameCharListTask(game.id));
    ...
    protected void initialize() {
        ...
        personListView.setCellFactory(listChar -> {
            ...
            var loader = new FXMLLoaderProxy<Region, PersonCellController>(VIEW_GAME_DETAIL_PART_PERSON_CELL_FXML);
